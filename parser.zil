...
<ROUTINE PARSER ("AUX" (PTR ,P-LEXSTART) WRD (VAL 0) (VERB <>) (DONT <>)
		 OMERGED OWINNER LEN (DIR <>) (NW 0) (LW 0) (CNT -1)) 
	<REPEAT ()
...
<ROUTINE NAME? (WRD)
	 <COND (<OR <EQUAL? .WRD ,W?FORD ,W?ZAPHOD ,W?BEEBLEBRO>
		    <EQUAL? .WRD ,W?TRILLIAN ,W?TRICIA ,W?MCMILLAN>
		    <EQUAL? .WRD ,W?PROSSER ,W?MARVIN ,W?ARTHUR>
		    <EQUAL? .WRD ,W?DENT ,W?PREFECT ,W?PHIL>
		 ...
		 (T
		  ...
		  <COND (<EQUAL? .WRD ,W?ALL ,W?BOTH>
			...
			(<AND ;<SET WV <WT? .WRD ,PS?ADJECTIVE ;,P1?ADJECTIVE>>
			      <WT? .WRD ,PS?ADJECTIVE ;,P1?ADJECTIVE> ;"CLR"
			      <ADJ-CHECK .WRD>                ;"GTB"
...
<ROUTINE GET-OBJECT (TBL "OPTIONAL" (VRB T)
	 ...
	 <COND (<AND <NOT ,P-NAM> ,P-ADJ <WT? ,P-ADJ ,PS?OBJECT ;,P1?OBJECT>>
		<SETG P-NAM ,P-ADJ>
		<SETG P-ADJ <>>)>
	 <COND (<AND <NOT ,P-NAM>
		     <NOT ,P-ADJ>
 ...
 <COND (<FSET? .OBJ ,INVISIBLE> <RFALSE>)
	...
	<RFALSE>)
       (<AND ,P-ADJ
		 ...
		 <NOT <INTBL? ,P-ADJ .SYNS <- <PTSIZE .SYNS> 1>>>>>
	<RFALSE>)
	...
	<RFALSE>)
       (<AND ,P-ADJ
		 ...
		 <NOT %<COND (<AND <GASSIGNED? PLUS-MODE> ,PLUS-MODE>
			     ...
			     ;(T
			      '<INTBL? ,P-ADJ .SYNS <RMGL-SIZE .SYNS> 1>)>>>>
	<RFALSE>)
